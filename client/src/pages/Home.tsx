      ...
      <header className="sticky top-0 z-50 bg-[#1a1c1e]/90 backdrop-blur-md border-b border-white/5">
        <div className="container flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#agregar" className="text-sm font-medium text-slate-400 hover:text-white transition-colors">Agregar</a>
          </nav>
          <a 
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              <a href={whatsappLinkSandro} target="_blank" rel="noopener noreferrer">
                <Button className="w-full sm:w-auto bg-white text-black hover:bg-slate-200 h-14 px-10 rounded-full font-bold text-base transition-all">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-sm text-slate-400">
                ...
                <li><a href="#agregar" className="hover:text-white transition-colors">Agregar Veículo</a></li>
